...
{{--                                <small>--}}
{{--                                    Existing:--}}
{{--                                    @if(count($existing_methods) > 0)--}}
{{--                                        @foreach($existing_methods as $method)--}}
{{--                                            {{$method}}--}}
{{--                                            <span wire:loading wire:target="removePaymentMethod({{$method}})" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>--}}
{{--                                            <span style="cursor:pointer;" wire:loading.remove wire:target="removePaymentMethod({{$method}})"   wire:click="removePaymentMethod({{$method}})" class="fa fa-trash"></span>--}}
{{--                                            @if(!$loop->last)--}}
{{--                                                ,--}}
{{--                                            @endif--}}
{{--                                        @endforeach--}}
{{--                                    @endif--}}
{{--                                </small>--}}
{{--                                <select multiple wire:model.lazy="payment_methods" class="form-select {{$errors->has('payment_methods')? 'is-invalid' : '' }} mt-1">--}}
...
{{--                            </div>--}}
                            <div class="mb-2">
                                ...
                                <textarea wire:model.lazy="invoice_note" class="form-control {{$errors->has('invoice_note')? 'is-invalid' : '' }}" rows="2" placeholder="Drop a note on the invoice">{{$invoice_note}}</textarea>
        ...
        <div class="col-xl-3 col-md-4 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary w-100 mb-75"  wire:loading wire:target="updateInvoice"  type="button" disabled>Please wait <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></button>
                    <button class="btn btn-primary w-100 mb-75" wire:loading.remove wire:target="updateInvoice" type="submit">Update invoice </button>
