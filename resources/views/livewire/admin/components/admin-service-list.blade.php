                        ...
                        <div class="ecommerce-header-items">
                            <div class="result-toggler">
                                ...
                                <div class="search-results">
                                    <h6 wire:loading.remove wire:target="search" class="filter-heading">@if($searchResult)  {{count($searchResult)}}  @else {{count($catalogues)}} @endif results found</h6>
                ...
                <div class="row mt-1">
                    <div class="col-sm-12">
                        <div class="input-group input-group-merge">
                            <input type="text" wire:model="search" class="form-control search-product" id="shop-search" placeholder="Search for service by name" aria-label="Search..." aria-describedby="shop-search" />
                    ...
                    @foreach($catalogues as $catalogue)
                        <div class="card ecommerce-card">
                            <div class="item-img text-center">
                                ...
                                <a href="{{route('admin.catalogue-details', $catalogue->id)}}">
                                    ...
                                    <div class="item-rating">
                                        <ul class="unstyled-list list-inline">
                                            ...
                                            @if($catalogue->company)
                                                    <a href="{{route('admin.company-profile', $catalogue->company->id)}}">
                                                        <span class="badge badge-light-primary">{{Str::limit($catalogue->company->name, 15, $end='...')}}</span>
                                                    </a>
                                            @else
                            ...
                            <div class="item-options text-center">
                                ...
                                <a href="{{route('admin.catalogue-details', $catalogue->id)}}" class="btn btn-primary">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="product-categories">
                            <p>Categories</p>
                            <div class="input-group input-group-merge">
                                <input type="text" wire:model="categorySearch" class="form-control search-product" id="shop-search" placeholder="Search for category" aria-label="Search..." aria-describedby="shop-search" />
                                <span class="input-group-text"><i data-feather="search" class="text-muted"></i></span>
                            </div>
                            ...
                            <p>Companies</p>
                            <div class="input-group input-group-merge">
                                <input type="text" wire:model="companySearch" class="form-control search-product" id="shop-search" placeholder="Search for company" aria-label="Search..." aria-describedby="shop-search" />
                                <span class="input-group-text"><i data-feather="search" class="text-muted"></i></span>
                            </div>
                            <ul class="list-unstyled categories-list">
                                ...
                                @if($companies)
                                    @foreach($companies as $company)
                                        <li>
                                            <div class="form-check">
                                                <input type="radio" id="{{$company->name}}" name="company-filter" class="form-check-input" value="{{$company->id}}" wire:model="company" />
                                                <label class="form-check-label" for="{{$company->name}}">{{$company->name}}</label>
                                            </div>
                                        </li>
                                    @endforeach
                                @endif
