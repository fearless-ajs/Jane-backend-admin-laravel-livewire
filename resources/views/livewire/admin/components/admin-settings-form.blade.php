<div class="row">
    <div class="col-12">
        <ul class="nav nav-pills mb-2">
            ...
            <!-- security -->
            <li class="nav-item">
                <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#editUserPrimaryProfileForm" >
        ...
        <div class="card">
            ...
            <div class="card-body py-2 my-25">
                ...
                <div class="d-flex">
                    <a href="#" class="me-25">
                        <img src="{{$settings->AppImage}}" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                    </a>
                    <!-- upload and reset button -->
                    <div class="d-flex align-items-end mt-75 ms-1">
                        <div>
                            <label for="account-upload" class="btn btn-sm btn-primary mb-75 me-75">Change logo</label>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#editUserPrimaryProfileForm" class="btn btn-sm btn-outline-secondary mb-75">Update my profile</button>
                ...
                <!-- form -->
                <form class="validate-form mt-2 pt-50" wire:submit.prevent="updateSetting">
                    <div class="row">
                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="accountAppName">App Name</label>
                            <input type="text" class="form-control {{$errors->has('app_name')? 'is-invalid' : '' }}" wire:model.lazy="app_name" id="accountAppName" placeholder="App Name"/>
                            @error('app_name') <span style="color: crimson; font-size: 10px;">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="accountEmail">Email</label>
                            <input type="email" wire:model.lazy="app_email" class="form-control {{$errors->has('app_email')? 'is-invalid' : '' }}" id="accountEmail" placeholder="App Email"  />
                            @error('app_email') <span style="color: crimson; font-size: 10px;">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-12 col-sm-6 mb-1">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            <label class="form-label" for="accountCountry">Country</label>
                            <select id="accountCountry" wire:model.lazy="app_country" class="form-select {{$errors->has('app_country')? 'is-invalid' : '' }}">
