<div class="row invoice-add">
    @if(!$company->address)
        <p style="text-align: center;">Please this company's profile needs to be completed. <a target="_blank" href="{{route('admin.company-settings', $company->id)}}"> Click here to proceed</a></p>
    @elseif(!$company->bankingInfo->account_number)
        <p style="text-align: center;">This company banking details needs to be completed. <a href="{{route('admin.company-settings', $company->id)}}"> Click here to proceed</a></p>
    @else
                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                            <div>
                                <div class="logo-wrapper">
                                    <h3 class="text-primary invoice-logo">{{$company->name}}</h3>
                                </div>
                                <p class="card-text mb-25 w-50">{{$company->address}}</p>
                                <p class="card-text mb-25">{{$company->city}}, {{$company->state}}, {{$company->country}}</p>
                                <p class="card-text mb-0">{{$company->phone}}, {{$company->email}}</p>
                            </div>
                            ...
                            <div class="col-xl-4 p-0 ps-xl-2 mt-xl-0 mt-2">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$company->bankingInfo->bank_name}}</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Country:</td>
                                        <td>{{$company->bankingInfo->country}}</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">IBAN:</td>
                                        <td>{{$company->bankingInfo->iban}}</td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">SWIFT code:</td>
                                        <td>{{$company->bankingInfo->swift_code}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
