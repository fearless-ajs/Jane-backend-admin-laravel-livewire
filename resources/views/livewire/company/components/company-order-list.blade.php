                        ...
                        <div class="ecommerce-header-items">
                            <div class="result-toggler">
                                ...
                                <div class="search-results">
                                    <h6 wire:loading.remove class="filter-heading"> @if($searchResult)  {{count($searchResult)}} @else {{count($company->cartOrders)}} @endif Orders</h6>
                    ...
                    @foreach($orders as $item)
                        <div class="card ecommerce-card">
                            <div class="item-img text-center">
                                <a href="{{route('company.order-details', $item->id)}}">
                            ...
                            <div class="item-options text-center">
                                ...
                                @endif
                                <a href="{{route('company.order-details', $item->id)}}" class="btn btn-primary">
                                    <span>Track</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="sidebar-shop">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="filter-title">Filer by date</h6>
                        <div class="form-group mb-2">
                            <label class="form-check-label" for="start_data">From:</label>
                            <input type="date" wire:model="from" id="start_date" class="form-control" />
                        </div>

                        <div class="form-group mb-2">
                            <label class="form-check-label" for="end_data">To:</label>
                            <input type="date" wire:model="to" id="end_date" class="form-control" />
                        </div>

                        <div id="clear-filters">
                            <button type="button" wire:click="clearFilter" class="btn w-100 btn-primary">Reset filter</button>
                        </div>
                        <!-- Clear Filters Ends -->
                    </div>
                </div>
