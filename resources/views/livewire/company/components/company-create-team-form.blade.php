<div class="modal fade" id="addTeamModal" wire:ignore.self tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 pb-5">
                <div class="text-center mb-4">
                    <h1 class="role-title">Add New Team</h1>
                    <p>Set team permissions</p>
                </div>
                <!-- Add role form -->
                <form  class="row" wire:submit.prevent="create">
                    <div class="col-12 mb-1">
                        <label class="form-label" for="modalRoleName">Team Name</label>
                    ...
                    <div class="col-12">
                        <label class="form-label" for="modalRoleName">Team Description</label>
                        <textarea wire:model.lazy="description" class="form-control {{$errors->has('description')? 'is-invalid' : '' }}" placeholder="Describe the duty of this team"></textarea>
                    ...
                    <div class="col-12 text-center mt-2">
                        <button type="submit" class="btn btn-primary" wire:loading.remove wire:target="create">Create Team</button>
