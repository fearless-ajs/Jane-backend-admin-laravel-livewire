        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Add New Contact</h1>
                    <p>Add new contact/customer to your company.</p>
                </div>
...
{{--                    </div>--}}
                    ...
                    <div class="col-12 text-center mt-2 pt-50">
                        <button type="submit"  wire:loading.remove wire:target="addContact"  class="btn btn-primary me-1">Add contact</button>
                        <button type="submit"  wire:loading wire:target="addContact"  class="btn btn-primary me-1"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></button>
