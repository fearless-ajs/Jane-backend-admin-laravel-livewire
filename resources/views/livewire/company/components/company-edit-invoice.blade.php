        ...
        <div class="col-xl-3 col-md-4 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-success w-100 mb-75" href="{{route('company.preview-invoice', $invoice->id)}}" wire:loading.remove wire:target="updateInvoice">Preview invoice</a>
                </div>
            </div>
        </div>
