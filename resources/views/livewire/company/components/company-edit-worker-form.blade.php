<div class="modal fade current-modal" wire:ignore.self id="editUser" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form class="row gy-1 pt-75" wire:submit.prevent="updateWorker">
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="basic-icon-default-company">Staff image <small wire:loading wire:target="image" class="form-text text-muted"><i class="fa fa-spin"><i class="fa fa-spinner"></i></i>&nbsp; Validating Image</small></label>
