        ...
        <div class="col-xl-4 col-md-6 col-12">
            <div class="card card-congratulation-medal">
                <div class="card-body">
                    ...
                    <p class="card-text font-small-3">Contact dashboard</p>
                    <h3 class="mb-75 mt-2 pt-50">
                        <a href="#">{{ \Carbon\Carbon::now()->translatedFormat(' j F Y')}}</a>
                    </h3>
                    <a href="{{route('contact.catalogues')}}" type="button" class="btn btn-primary">View Market</a>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="d-flex flex-row">
                                ...
                                <div class="my-auto">
                                    <h4 class="fw-bolder mb-0">{{count($signedInvoices)}}</h4>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="d-flex flex-row">
                                ...
                                <div class="my-auto">
                                    <h4 class="fw-bolder mb-0">{{count($unsignedInvoices)}}</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th>Catalog</th>
                                <th>Category</th>
                                <th>Price({{$settings->currency->currency_symbol}})</th>
                                <th>Type</th>
                                <th>Sales</th>
                            </tr>
                            </thead>
                            ...
                            @if(count($recentCatalog) > 0)
                                @foreach($recentCatalog as $catalog)
                                    <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar rounded">
                                            <div class="avatar-content">
                                                <img style="max-width: 100%;" src="{{$catalog->images->first()->picture}}" alt="Toolbar svg" />
                                            </div>
                                        </div>
                                        <div>
                                            <div class="fw-bolder">{{$catalog->name}}</div>
                                            <div class="font-small-2 text-muted">{{$catalog->company->name}}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-nowrap">
                                    <div class="d-flex flex-column">
                                        <span class="fw-bolder mb-25">{{$catalog->price}}</span>
                                        @if($catalog->tax)
                                            <span class="font-small-2 text-muted">Plus {{$catalog->tax->percentage}}% tax</span>
                                        @endif
                                    </div>
                                </td>
                                <td>{{ucwords($catalog->type)}}</td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fw-bolder me-1">68%</span>
                                        <i data-feather="trending-up" class="text-primary font-medium-1"></i>
                                    </div>
                                </td>
                            </tr>
                                @endforeach
