            ...
            <form id="formAccountSettings" class="validate-form" onsubmit="return false">
                <div class="row">
                    ...
                    <div class="mb-1 col-md-6">
                        ...
                        <select wire:model.lazy="country"  class="form-select select2 {{$errors->has('country')? 'is-invalid' : '' }}">
                ...
                <div class="mt-2">
                    <button type="submit"  wire:loading.remove wire:target="save"  class="btn btn-primary me-1">Save changes</button>
                    <button type="button" disabled  wire:loading wire:target="save"  class="btn btn-primary me-1"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></button>
                </div>
            </form>
        </div>
    </form>
