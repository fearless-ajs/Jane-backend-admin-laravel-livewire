    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(Auth::user()->hasRole('super-admin'))
                <li class="nav-item @if(Route::currentRouteName() == 'admin.companies' || Route::currentRouteName() == 'company.create-invoice') active @endif"><a class="d-flex align-items-center" href="#"><i class="fa fa-file"></i><span class="menu-title text-truncate" data-i18n="Invoice">Companies</span></a>
