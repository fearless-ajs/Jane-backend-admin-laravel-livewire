        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('company.dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
                <ul class="menu-content">
                    <li class="@if(Route::currentRouteName() == 'admin.dashboard') active @endif"><a class="d-flex align-items-center" href="{{route('admin.dashboard')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Admin</span></a>
                    </li>
                </ul>
            </li>
            ...
            @if(Auth::user()->hasRole('super-admin'))
                <li class="nav-item @if(Route::currentRouteName() == 'admin.companies' || Route::currentRouteName() == 'company.create-invoice') active @endif"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Companies</span></a>
                    <ul class="menu-content">
