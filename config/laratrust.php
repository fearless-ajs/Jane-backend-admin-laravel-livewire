...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the array that contains the information of the contact models.
    | This information is used in the add-trait command, for the roles and
    | permissions relationships with the possible contact models, and the
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            /**
             * Redirects the contact to the given url.
    ...
    'teams' => [
        ...
        */
        ...
        | it will check only if the contact has attached that role/permission ignoring the team.
        |
        */
        'strict_check' => false,
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Determines if you can check if a contact has a permission using the "can" method.
    |
    */
    ...
    */
    'panel' => [
        ...
        */
        'roles_restrictions' => [
            // The contact won't be able to remove roles already assigned to users.
            'not_removable' => [],

            // The contact won't be able to edit the role and the permissions assigned.
            'not_editable' => [],

            // The contact won't be able to delete the role.
            'not_deletable' => [],
        ],
    ]
];
