...
class AdminCompanyCreateInvoiceForm extends Component
{
    public $to;
    public $worker;
    ...
    public function fetchUsersData(){
        $this->contacts  = Contact::where('company_id', $this->company->id)->get();
        $this->workers   = Worker::where('company_id', $this->company->id)->get();
        $this->products  = CompanyCatalogue::where('company_id', $this->company->id)->where('type', 'product')->get();
        $this->services  = CompanyCatalogue::where('company_id', $this->company->id)->where('type', 'service')->get();
    ...
    {
        return view('livewire.admin.components.admin-company-create-invoice-form');
    }
}
