...
class CompanyOrderDetails extends LiveNotify
{
    use EmailProvider;
    public $item;
    ...
    public function cancelService(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'SERVICE TERMINATED',
    ...
    public function resumeService(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'SERVICE RESUMED',
    ...
    public function cancelOrder($order_id){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ORDER CANCELLED',
    ...
    public function resume($order_id){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ORDER RESUMED',
    ...
    public function confirmOrder(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ORDER CONFIRMED',
    ...
    public function shipOrder(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ODER READY FOR SHIPPING',
    ...
    public function moveOrderForDelivery(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ORDER MOVED OUT FOR DELIVERY',
    ...
    public function orderDelivered(){
        ...
        $this->sendPipelineEmail($this->item->cartOrder->user, $this->item, 'ODER DELIVERED',
    ...
    {
        return view('livewire.company.components.company-order-details');
    }
}
